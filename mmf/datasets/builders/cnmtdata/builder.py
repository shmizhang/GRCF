...
from mmf.datasets.builders.cnmtdata.dataset import CnmtDataset
from mmf.datasets.builders.textvqa.builder import TextVQABuilder
from mmf.common.registry import registry

@registry.register_builder("cnmtdata")
class CnmtBuilder(TextVQABuilder):
    def __init__(
        self, dataset_name="cnmtdata", dataset_class=CnmtDataset, *args, **kwargs
    ):
        super().__init__(dataset_name, dataset_class, *args, **kwargs)

    @classmethod
    def config_path(cls):
        return "configs/datasets/cnmtdata/defaults.yaml"
