...
class CnmtDataset(MMFDataset):
    def __init__(self, config, dataset_type, imdb_file_index, *args, **kwargs):
        super().__init__("cnmtdata",config, dataset_type, imdb_file_index, *args, **kwargs)
        self.dataset_name = "cnmtdata"
    ...
    def add_sample_details(self, sample_info, sample):
        #print("add_answer_detail")
        #print(sample_info)
        #print(len(sample_info["obj_normalized_boxes"]))
        #print(len(sample_info["obj_normalized_boxes"][0]))
        ...
        #print("sample_infoocr_normalized_boxes")
        #print(sample_info["ocr_normalized_boxes"])
        # 3. Load OCR
        if not self.use_ocr:
        ...
        #sample.context_tokens_enc = object_to_byte_tensor(context["tokens"])
        ...
        elif "ocr_normalized_boxes" in sample_info and hasattr(self, "copy_processor"):
        ...
        sample.ocr_token = ocr_tokens[:max_len]
        #print("sample")
        #print(sample.train_prev_inds)
        #print(sample.ocr_token)
