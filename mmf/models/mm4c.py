...
class MM4C(BaseModel):
    ...
    def _forward_ocr_encoding(self, sample_list, fwd_results):
        #print("sample_list0")
        #print(sample_list.image_feature_0)
        #print(sample_list.image_feature_1)
        ...
        ) + self.ocr_bbox_layer_norm(self.linear_ocr_bbox_to_mmt_in(ocr_bbox)) + self.ocr_conf_layer_norm(self.linear_ocr_conf_to_mmt_in(ocr_conf))
